        ...
        <div className={cn(s.container)}>
            ...
            <div className={cn(s.cardContainer, inter.className)}>
                <div className={cn(s.card)}>
                    <img src="/3exper/images/competition.png" className={cn(s.image)}/>
                ...
                <div className={cn(s.card)}>
                    <img src="/3exper/images/no-phone.png" className={cn(s.image)}/>
                ...
                <div className={cn(s.card)}>
                    <img src="/3exper/images/laugh.png" className={cn(s.image)}/>
